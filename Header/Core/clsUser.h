...
private:
    ...
    static stLoginRecord _ConvertLinetoLoginRecord(string Line, string Seperator = "#//#")
    {
        ...
        LoginRecord.DateAndTime = vLoginData[0];
        LoginRecord.UserName = vLoginData[1];
        LoginRecord.Password = vLoginData[2];
        LoginRecord.Permissions = stoi(vLoginData[3]);
        return LoginRecord;
    }
    static  vector <stLoginRecord> _LoadLoginDataFromFile()
    {

        vector <stLoginRecord> vLogin;
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                ...
                stLoginRecord Login = _ConvertLinetoLoginRecord(Line);
...
public:
    ...
    static vector <stLoginRecord> GetLoginList()
      {
